...
class eatlivr extends ObjectModel
{
    public $id_eatlivr_comment;
    public $id_product;
    public $firstname;
    public $lastname;
    public $email;
    ...
    public static $definition = array(
        'table' => 'eatlivr_comment',
        'primary' => 'id_eatlivr_comment',
        'multilang' => false,
        'fields' => array(
    ...
    public static function getProductNbComments($id_product)
    {
        ...
        FROM `'._DB_PREFIX_.'eatlivr_comment`
    ...
    public static function getProductComments($id_product, $limit_start, $limit_end = false)
    {
        ...
        SELECT * FROM `'._DB_PREFIX_.'eatlivr_comment`
        WHERE `id_product` = '.(int)$id_product.'
    ...
    public static function getCustomerComments($email, $limit_start, $limit_end = false)
    {
		...
		FROM `'._DB_PREFIX_.'eatlivr_comment` pc
    ...
    public static function getInfosOnProductsList($id_product_list)
    {
        ...
        SELECT `id_product`, AVG(`grade`) as grade_avg, count(`id_eatlivr_comment`) as nb_comments
        FROM `'._DB_PREFIX_.'eatlivr_comment`
