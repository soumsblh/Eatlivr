...
$(document).ready(function(){
    ...
    $('.postdeliv').on('click', 'i.icon-plus-sign', function(){
        data_and = $('#and_text').val();
        data_carrier = $(this).attr('data-carrier');
        data_range_plus = parseInt( $(this).attr('data-range') ) + 1;
        data_range = parseInt( $(this).attr('data-range') );

        $(this).parent().after(
            '<div class="postal_range">' +
                '<input type="text" name="postcode_range_from_'+ data_carrier +'_'+ data_range_plus +'" class="inline fixed-width-lg">' +
                ' ' + data_and + ' ' +
                '<input type="text" name="postcode_range_to_'+ data_carrier +'_'+ data_range_plus +'" class="inline fixed-width-lg">' + ' ' +
                '<i data-range="'+ data_range_plus +'" data-carrier="'+ data_carrier +'" class="icon-plus-sign"></i>' +
            '</div>');
        $(this).after('<i data-range="'+ data_range +'" data-carrier="'+ data_carrier +'" class="icon-minus-sign"></i>');
        $(this).remove();
    })

    $('.postdeliv').on('click', 'i.icon-minus-sign', function(){
        conf = confirm( $('#delete_confirm').val() );
        if ( conf == true )
            $(this).parent().remove();
    })
});